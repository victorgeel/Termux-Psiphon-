...
const (
	appName        = "TermuxPsi"
	appVersionName = "Psiphon Pro Mod"
	appVersionCode = "1.1.202314"

	copyrightYear   = "2023"
	copyrightAuthor = "Victor is geek"
)
...
func main() {
	...
	flag.StringVar(&config.Inject.Payload, "payload", defaultConfig.Inject.Payload, "Set payload")
	flag.IntVar(&config.Inject.Type, "type", defaultConfig.Inject.Type, "Set payload type")
	flag.IntVar(&defaultConfig.PsiphonCore, "core", defaultConfig.PsiphonCore, "Set Psiphon core")
